...
public enum ErrorCode {
    ...
    EXTERNAL_API_ERROR("외부 API 호출 실패", HttpStatus.FAILED_DEPENDENCY),
    ...
    INVALID_QUANTITY("수량이 안맞습니다.", HttpStatus.BAD_REQUEST),
    ...
    NOT_EXIST_STORAGE_LOCATION("냉장고 타입에 맞는 location 이 없습니다.",HttpStatus.BAD_REQUEST),
